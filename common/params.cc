...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"HybridTACC", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VEHICLES},
    {"TACC", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VEHICLES},
    ...
    {"VirtualTorqueBlending", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_VEHICLES},
